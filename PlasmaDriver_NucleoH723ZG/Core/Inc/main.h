...
#define INP_COMP_IRQ_Pin GPIO_PIN_14
#define INP_COMP_IRQ_GPIO_Port GPIOE
#define INP_COMP_IRQ_EXTI_IRQn EXTI15_10_IRQn
#define POWER_OFF_IRQ_Pin GPIO_PIN_15
#define POWER_OFF_IRQ_GPIO_Port GPIOE
#define POWER_OFF_IRQ_EXTI_IRQn EXTI15_10_IRQn
